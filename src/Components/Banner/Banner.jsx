            ...
            <div>
                <div className="bg-[#9538E2] rounded-b-2xl pt-6 h-[694px]">
                    ...
                    <div className="flex justify-center mt-8">
                        <button className="text-[#9538E2] bg-white rounded-3xl font-bold text-xl py-[15px] px-6 hover:bg-blue-600 hover:text-white hover:transition hover:duration-700 hover:ease-in-out">Shop Now</button>
                    </div>
                </div>
